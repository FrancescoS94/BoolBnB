            ...
            <div class="col-md-8">
                ...
                {{-- <form action="{{ route('admin.addresses.update', $addresses->id)}}" method="post"> --}}
                    ...
                    <div class="form-group">
                        ...
                        <input id="country" type="text" class="form-control" name="country" value="{{ $flat->country }}">
                    </div>

                    <div class="form-group">
                        <label for="city">Città</label>
                        <input id="city" type="text" class="form-control" name="city" value="{{ $flat->city }}">
                    </div>

                    <div class="form-group">
                        <label for="address">Indirizzo</label>
                        <input id="address" type="text" class="form-control" name="address" value="{{ $flat->address }}">
                    </div>
                    
                    <div class="form-group">
                        <label for="cap">CAP</label>
                        <input id="cap" type="text" class="form-control" name="cap" value="{{ $flat->cap }}">
                    </div>
                    
                    <div class="form-group">
                        <label for="district">Provincia</label>
                        <input id="district" type="text" class="form-control" name="district" value="{{ $flat->district }}">
                    </div>
